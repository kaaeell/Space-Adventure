...
# ============================================
# Your ship and crew info
# ============================================

you = {
    "fuel": 5000,          # Gas to fly!
    "credits": 1000,       # Space money
    "missions": 0,         # Trips you've done
    "streak": 0,           # Hot streak!
    "morale": 80,          # How happy your crew is
    "research": 0,         # Science points
    "rank": 1,             # Bounty hunter level
    "record": 0,           # Furthest you've gone
    "total_distance": 0,   # Total km traveled
    "achievements": [],    # Trophies earned
    "inventory": [],       # Stuff you found
    "pets": [],            # Cute space friends
    "luck": 0,             # How lucky you are today
    "last_played": None,   # When you last played
    "pirates_killed": 0,   # Bad guys caught
    "nebulae_visited": 0,  # Clouds explored
    "jokes_told": 0,       # Funny moments
    "sessions": 0,         # Times you've played
